...
- Generation/control change: run `tests/test_run_control.py`, `tests/test_generation_pool_contract.py`, and telemetry contracts; exercise an external stop followed by resume.
